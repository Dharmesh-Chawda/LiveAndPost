    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav">
                ...
                <?php else: ?>
                    <li class="nav-item active">
                        <a class="nav-link btn btn-info" href="dashboard.php">Dashboard</a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link btn btn-info" href="profile.php">Edit Profile</a>
                    </li>
                    
                    <?php if(isset($_SESSION["username"]) && $_SESSION['user_role']==1):?>
                        <li class="nav-item active">
                            <a class="nav-link btn btn-info" href="post.php">Add Post</a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link btn btn-info" href="users.php">All Users</a>
                        </li>
                    <?php endif; ?>
                    <li class="nav-item active">
                        <a class="nav-link btn btn-info" href="./authentication/logout.php">Logout</a>
                    </li>
                <?php endif; ?>
                <li class="nav-item active">
